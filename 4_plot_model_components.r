...
ggsave("figures/mu_trend.pdf", plot = p, width = 5.5, height = 3.5)
...
ggsave("figures/mu_daily.pdf", plot = p, width = 5.5, height = 3.5)
...
ggsave("figures/mu_weekly.pdf", plot = p, width = 5.5, height = 3.5)
...
ggsave("figures/day_week.pdf", plot = p, width = 5.5, height = 3.5)
...
ggsave("figures/gt.pdf", plot = p, width = 4.5, height=3.5)
...
ggsave("figures/hs.pdf", plot = p, width = 3.5, height = 3.5)
